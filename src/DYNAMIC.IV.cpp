...
Eigen::VectorXd WH_DYNAMIC_IV_sim(const double n_max = 250,
...
//' @export
// [[Rcpp::export]]
Eigen::VectorXd WH_DYNAMIC_IV(std::string name = "scenario 1", double n_max = 204,
  ...
  for (int i = i_start; i < i_end; i++) {
    sims.row(i) = WH_DYNAMIC_IV_sim(n_max, p_arm0surv, p_arm1surv, t_surv, p_arm0tox1, p_arm1tox1, p_arm0tox2, p_arm1tox2, p_LTFU,
